...
async function getCityCoord(city) {
  const { data } = await axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('http://api.openweathermap.org/geo/1.0/direct', {
    params: {
      q: city,
